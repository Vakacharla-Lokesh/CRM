export function populateLeadsTable(leads) {
  ...
  leads.forEach((lead, index) => {
    ...
    row.setAttribute("data-lead-id", lead.leadId);
    row.className =
    ...
    row.innerHTML = `
      <td class="w-4 p-4">
        <input type="checkbox" class="item-checkbox w-4 h-4 text-blue-600 bg-gray-100 dark:bg-gray-600 border-gray-300 dark:border-gray-500 rounded focus:ring-blue-500 dark:focus:ring-blue-600 focus:ring-2" value="${lead.leadId}" />
      </td>
      ...
      <td class="px-3 py-4">
        <div class="flex flex-row gap-1">
            <a id="editLead" href="/leadDetails" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors cursor-pointer">

...
self.onmessage = (e) => {
  ...
  switch (e.data.action) {
    ...
    case "syncData":
      if (e.data.operation === "insert") {
        insertData(e.data.data, e.data.storeName, dbReady, db);
      } else if (e.data.operation === "update") {
        updateData(e.data.storeName, e.data.data, dbReady, db);
      } else if (e.data.operation === "delete") {
        deleteData(e.data.data.id, e.data.storeName, dbReady, db);
      }
      break;

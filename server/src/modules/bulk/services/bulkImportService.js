...
export const bulkImportLeads = wrapServiceFn(
  async function bulkImportLeads(file, context) {
...
export const bulkImportOrganizations = wrapServiceFn(
  async function bulkImportOrganizations(file, context) {
    ...
    for (let i = 0; i < rawRows.length; i++) {
      ...
      validDocs.push({
        ...
        size:
          normalised.size !== undefined ? Number(normalised.size) : undefined,
...
export const bulkImportDeals = wrapServiceFn(
  async function bulkImportDeals(file, context) {

...
export const otpEmailHTML = (otp, expiryMinutes) => `
...
export const passwordResetConfirmationHTML = () => `
<div style="margin:0;padding:0;background-color:#f4f6fb;font-family:Arial,Helvetica,sans-serif;">
        <table width="100%" cellpadding="0" cellspacing="0" style="padding:40px 0;">
          <tr>
            <td align="center">
...
export const adminMailHTML = (tenant, randomPassword) => `
<div style="margin:0;padding:0;background-color:#f4f6fb;font-family:Arial,Helvetica,sans-serif;">
        <table width="100%" cellpadding="0" cellspacing="0" style="padding:40px 0;">
          <tr>
            <td align="center">
...
export const userMailHTML = (user, password) => `
<div style="margin:0;padding:0;background-color:#f4f6fb;font-family:Arial,Helvetica,sans-serif;">
        <table width="100%" cellpadding="0" cellspacing="0" style="padding:40px 0;">
          <tr>
            <td align="center">
...
export const sendLeadReminderMailHTML = (to, userName, leadName, leadId) => `
<!DOCTYPE html>
  <html>
...
const emailTemplates = {
  ...
  adminMail: (tenant, randomPassword) => ({
    ...
    html: adminMailHTML(tenant, randomPassword),
  }),

  userEmail: (user, password) => ({
    from: `"${FROM_NAME()}" <${FROM_EMAIL()}>`,
    to: user.email,
    subject: "Your Account Credentials have been created",
    html: userMailHTML(user, password),
  ...
  sendLeadReminderMail: (to, userName, leadName, leadId) => ({
    ...
    html: sendLeadReminderMailHTML(to, userName, leadName, leadId),
  }),
};
